<%-- 
    Document   : tender
    Created on : 10 Aug, 2021, 3:04:46 PM
                ...
                <table style="margin:0 auto;width: 90%" cellspacing="10px">
                    ...
                    <%
                        ...
                        <tr>
                            ...
                            <td style="background-color:lightgoldenrodyellow;font-family:cursive;outline:none;border:none;box-shadow:5px 2px 5px 5px black;height:30px;width:15%;font-size:15px;"><%=rs.getString("title")%></td>
