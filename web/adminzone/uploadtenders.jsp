<%-- 
    ...
    Created on : 10 Aug, 2021, 12:30:27 PM
            ...
            <div id="parent">
                <form action="../upload" method="post" enctype="multipart/form-data"><br/> 
                     <h1 style="text-align:center;margin-top:-10px;font-size: 50px;font-family: Impact, sans-serif;color: white;text-shadow: 2px 2px 5px red;">
                            Upload Notice/Tenders
                        </h1>
                         
                        <table style="margin:0 auto;width:70%;"cellspacing="10px">
                             <tr>
                                <td style="height: 40px;width:35%;font-family: consolas;font-size:20px;">Title Name</td>
                                <td>
                                    <input type="text" name="title" required style="border-radius: 30px;padding:20px;background-color:#51BCA4;outline:none;border:none;box-shadow:5px 2px 5px 5px black;height:40px;width:98.4%;font-family: consolas;font-size:20px;color: white;"> 
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td   style="text-align: center;">
                                    <input type="submit" value="Upload" style="height: 40px;width:60%;box-shadow:5px 2px 5px 5px black;border-radius:20px;outline:none;font-family: consolas;font-size: 30px;cursor: pointer;"/>
                                </td>
                            </tr>
                        </table>
                ...
                <table style="margin:0 auto;width: 90%">
                    <tr>
                        ...
                        <th style="background-color:#F75D59;font-family: Impact, sans-serif;outline:none;border:none;box-shadow:5px 2px 5px 5px black;height:30px;width:auto;font-size:15px;color: white;">Title Name</th>
                    ...
                    <%
                        ...
                        <tr>
                            ...
                            <td style="background-color:lightseagreen;font-family:consolas;border-radius: 20px;padding:5px;outline:none;border:none;box-shadow:5px 2px 5px 5px black;height:20px;width:auto;font-size:10px;color: white;"><%=rs.getString("title")%></td>
